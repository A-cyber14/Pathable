...
// The 6 required photo categories for every business profile
const PHOTO_SLOTS = [
  { label: "Entrance",           icon: "🚪" },
  { label: "Bathroom",           icon: "🚻" },
...
// ---------------------------------------------------------------------------
// Feature card — matches the 4-card grid in Location_Full_Page mockups
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Check row — green tick + label (Location_Full_Page_Part_2 mockup)
// ---------------------------------------------------------------------------
...
// BusinessDetailPage
// Route: /business/:id
// Matches Image 6 + Location_Full_Page mockups
// ---------------------------------------------------------------------------
  ...
  return (
    <div style={{ fontFamily: "sans-serif", backgroundColor: "#f9fafb", minHeight: "100vh" }}>
      ...
      <div style={{ maxWidth: "900px", margin: "0 auto", padding: "24px 20px" }}>
        ...
        {/* Back to Map link — Image 6 top left */}
        <button
          onClick={() => navigate("/")}
          style={{
            background:    "none",
        ...
        {/* HEADER — name, score, address, description (Image 6) */}
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "6px" }}>
          <h1 style={{ margin: 0, fontSize: "28px", fontWeight: "800", color: "#111827" }}>
            {business.name}
          </h1>
          {/* Pathable Score badge — placeholder per PRD */}
        ...
        {/* PHOTO GRID — always shown, 6 slots (Image 6) */}
        <div style={{ marginBottom: "28px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "12px" }}>
            ...
            <span
              style={{
                backgroundColor: photos.length > 0 ? "#111827" : "#e5e7eb",
                color:           photos.length > 0 ? "#fff" : "#6b7280",
                borderRadius:    "999px",
                padding:         "1px 8px",
                fontSize:        "12px",
                fontWeight:      "600",
            ...
            {PHOTO_SLOTS.map((slot, i) => {
              ...
              return url ? (
                ...
                >
                  ...
                  <span style={{ fontSize: "11px", color: "#9ca3af", textAlign: "center", fontWeight: "500" }}>
                    {slot.label}
                  </span>
        ...
        {/* FEATURE CARDS GRID — 4 cards (Location_Full_Page_Part_2 mockup) */}
        ...
        {/* ACTION BAR — Add to Bookmarks + Report Issue (Location_Full_Page_Part_2) */}
